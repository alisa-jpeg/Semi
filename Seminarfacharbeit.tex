...
\defbibfilter{internet}{type=onlinedokument or type=onlinelexikon}

\defbibfilter{literat}{type=zeitschriftartikel or type=buch}


\printbibliography[filter = literat, heading=bibliography, title={Literaturverzeichnis}]

\printbibliography[filter = internet, heading=bibliography, title={Internetquellen}]
