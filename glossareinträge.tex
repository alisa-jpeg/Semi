...
%WICHTIG! wenn Änderungen an den Glossareinträgen vorgenommen werden, muss die .glo Datei gelöscht und das Dokument zweimal kompiliert werden, damit die Änderungen im Dokument sichtbar werden!
\begin{comment}
    zum kopieren:
    \newglossaryentry{}
    {}
