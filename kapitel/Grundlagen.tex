...
\begin{minipage}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=6cm,keepaspectratio]{bilder/finger_electrodes.jpg}
    \small Quelle: \cite{xing2018}    
    \captionof{figure}{Fingerelektroden}
    \label{Fingerelektroden}
\end{minipage}
\hfill
\begin{minipage}[t]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth,height=6cm,keepaspectratio]{bilder/spikey_electrodes.jpg}
    \small Quelle: \cite{openbci2025}
    \captionof{figure}{Spitze Elektroden}
    \label{Spitze Elektroden}
\end{minipage}
